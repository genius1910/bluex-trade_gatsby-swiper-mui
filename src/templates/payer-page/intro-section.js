...
const IntroSectionFrame = styled.div`
  ...
  width: 100%;
  height: fit-content;
  border-top: 0.625rem solid ${Colors.BORDER_BLUE};
  background-image: linear-gradient(to top, #fffefe, #ebfaff);
`;
...
const PayerIntroSection = ({ contents }) => {
  return (
    <IntroSectionFrame>
      <IntroSectionWrapper>
        <Box mb="2.5rem">
...
export default PayerIntroSection;

...
const VendorServicePromotionAgreementPage = ({ data, location }) => {
  ...
  return (
    <Layout type={LayoutType.SUPPORT} contents={layout} location={location}>
      <PolicyTemplateMain
        ...
        title={contents.Promotion_Agreement_Title}
        date={contents.Promotion_Agreement_TimeStamp}
        paragraphs={contents.Promotion_Agreement_Paragraph_List}
      />
    </Layout>
  );
};

export default VendorServicePromotionAgreementPage;
  ...
  query {
    ...
    allStrapiPolicyContent {
      nodes {
        ...
        Promotion_Agreement_Paragraph_List {
          title
          titleSize
          content {
            data {
